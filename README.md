...
## Appendix / 附录：Document Basis / 文档依据

This manual was written from the provided Clipo screenshots and the uploaded codebase representation. Some UI wording may be adjusted in future app versions.  
本手册根据你提供的 Clipo 界面截图和上传的代码仓库整理而成。后续版本中，部分界面文案可能会继续调整。
